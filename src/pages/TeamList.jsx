...
import React, { useState } from 'react';
import {
  Box, Typography, IconButton, Tabs, Tab, TextField, Button, Paper
} from '@mui/material';
import EditIcon from '@mui/icons-material/Edit';
import DeleteIcon from '@mui/icons-material/Delete';
      ...
      {displayedEmployees.map(employee => (
        <Paper
          ...
          sx={{
            ...
            borderRadius: 1,
            cursor: 'grab',
            backgroundColor: editId === employee.id ? '#eef7ff' : '#fafafa',
          }}
        >
          <DragIndicatorIcon fontSize="small" sx={{ mr: 1, color: '#999' }} />
          {editId === employee.id ? (
            <>
              <TextField
                size="small"
