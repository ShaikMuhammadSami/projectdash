...
// Updated AdminPanel.jsx based on new UI structure
...
function AdminPanel() {
  ...
  return (
    <Box display="flex" height="100vh">
      ...
      <Box flexGrow={1} display="flex" flexDirection="row" height="100%">
        ...
        <Box width="320px" p={2} borderLeft="1px solid #e0e0e0" sx={{ backgroundColor: '#f9f9f9' }}>
          <EmployeeList
            employees={employees}
            projects={projects}
            onAdd={handleAddEmployee}
